...
3) Access the `workbench` named `apr3-codegen-llamacpp-1-notebook`.
...
5) In the terminal, run `cd apr3-codegen-llamacpp-1` to navigate to your sample app's directory.
